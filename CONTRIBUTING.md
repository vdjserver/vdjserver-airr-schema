# Contributing to vdjserver-airr-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
vdjserver-airr-schema. These guidelines are not strict rules.
...
The vdjserver-airr-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the vdjserver-airr-schema technical leads
...
[issues]: https://github.com/vdjserver/vdjserver-airr-schema/issues/
[pulls]: https://github.com/vdjserver/vdjserver-airr-schema/pulls/
